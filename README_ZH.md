...
| Lint | 前端 / JS / TS | [Oxlint](https://oxc.rs/docs/guide/usage/linter.html) | 面向大仓库和 CI 的高性能 Lint 工具，建议先启用“高信号”的正确性规则，再按项目需要逐步加严。 | <https://oxc.rs/docs/guide/usage/linter.html> |
